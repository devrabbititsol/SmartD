package web.testsel.testd.webtestclasses;
...
import web.testsel.testd.webpageclasses.Screen1;
import web.testsel.testd.webpageclasses.Screen2;
...
String text1 = objScreen1.clkAContact_307622();
...
String text1 = objScreen2.textP16503528686_307942();
		if(text1.equalsIgnoreCase(configFileObj.getProperty("16503528686"+ i + datasetScreencount))){
			printSuccessLogAndReport(test, logger,  "Validating Text is displayed as : " + configFileObj.getProperty("16503528686"+ i + datasetScreencount));
		} else {
			printFailureLogAndReport(test, logger,  "Label Text is not displayed as : " + configFileObj.getProperty("16503528686"+ i + datasetScreencount));
		}
